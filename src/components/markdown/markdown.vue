...
<script>
    ...
    export default {
        name: 'markdown',
        props: ['mdValuesP', 'fullPageStatusP', 'editStatusP', 'previewStatusP', 'navStatusP', 'icoStatusP','parseP'],
        data() {
            return {
...
<style lang="scss">
    ...
    @import "../../../static/css/mk/reset";

    /*引入github的markdown样式文件*/

    @import "../../../static/css/mk/github-markdown.css";

    /*引入atom的代码高亮样式文件*/

    @import "../../../static/css/mk/atom-one-dark.min.css";
    .mdContainer {
        width: 100%;
        height: 100%;
